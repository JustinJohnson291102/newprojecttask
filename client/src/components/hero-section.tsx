...
export default function HeroSection() {
  return (
    <section className="bg-gray-100 pt-24 pb-16 relative overflow-hidden min-h-screen flex items-center">
      ...
      <motion.div
        className="absolute top-40 right-20 w-16 h-16 bg-white/10 rounded-2xl flex items-center justify-center animate-float"
        animate={{ y: [0, -20, 0] }}
        transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
      ></motion.div>

      <motion.div
        className="absolute bottom-40 left-16 w-20 h-20 bg-secondary/20 rounded-3xl flex items-center justify-center animate-bounce-slow"
        animate={{ rotate: [0, 360] }}
        transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
      ></motion.div>

      <motion.div
        className="absolute top-60 left-32 w-12 h-12 bg-yellow-400/20 rounded-full animate-glow"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="black">Never Stop</span> <br />
              Teaching
            </motion.h1>
