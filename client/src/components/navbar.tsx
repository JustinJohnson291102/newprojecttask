...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { path: "/courses", label: "Courses" },
    {
      ...
      label: "Packages",
      dropdown: [
        { path: "/packages/grow-wave", label: "Grow Wave" },
        { path: "/packages/expert-wave", label: "Expert Wave" },
        { path: "/packages/finance-wave", label: "Finance Wave" },
        { path: "/packages/creator-wave", label: "Creator Wave" },
        { path: "/packages/tech-wave", label: "Tech Wave" },
      ],
    },
